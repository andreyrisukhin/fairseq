"""
TODO migrate synthesizer_lm model here once registration works in transformer_lm.py
"""
...
from fairseq.models.svd import (
...
@register_model("svd_lm", dataclass=TransformerLanguageModelConfig)
class SVDLanguageModel(FairseqLanguageModel):
    # @classmethod
    # def hub_models(cls):
    ...
    def build_model(cls, args, task):
        ...
        decoder = TransformerDecoder( # TODO Check this, typo? Synth
...
def base_lm_architecture(args):
    ...
    # TODO add to these args, a custom synth string that specifies which attn arch to use
    # Just copy the way they interact with args
...
@register_model_architecture("svd_lm", "svd_lm_svd_attention")
def svd_lm_svd_attention(args):
    # # TODO param count
