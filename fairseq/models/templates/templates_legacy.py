...
@register_model("templates")
class TemplatesModel(TransformerModelBase):
    """
...
@register_model_architecture("templates", "templates_tiny")
...
@register_model_architecture("templates", "templates")
